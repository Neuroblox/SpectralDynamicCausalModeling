...
%--------------------------------------------------------------------------
% if numel(A) < 3, A{3} = spm_zeros(A{1}); end     % DHedit: remove modulatory params
% E.M   = 0*A{3};
% V.M   = ~~A{3}/32;
A     = D;
...
% E.D  = sparse(n,n);   V.D  = Q/64;                % delay   DHedit: remove this parameter set
