function [f,J] = spm_fx_cmc(x,u,P,M)        % DHedit: use [f,J] instead of [f,J,Q] which is set by standard
...
% j     = [7 2 3 4 1 5 6 8 9 10]; % DHedit: this is super strange! In
% % the file that sets the prior P.G is defined as a 2x4 matrix and thus only
% % up to index 4 in j is being used and equivalently changed in G. Why
% % should the rest stay untouched? Seems really arbitrary.
% for i = 1:size(P.G,2)
